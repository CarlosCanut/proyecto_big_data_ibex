...
# creates daily file
for day_iter in ['04_21', '05_18', '05_19', '05_20', '05_21', '05_25', '05_26', '05_27', '05_28', '05_31', '06_01']:
    ...
    for hour in ["09_30", "10_30", "11_30", "12_30", "13_30", "14_30", "15_30", "16_30", "17_30", "18_30"]:
        hour_df = pd.read_csv("stonks/temp/reduced_"+ year + "_" + month + "_" + day_iter + "_" + hour + ".csv")
        hour_df.columns = ['accion', 'ultima_cotizacion', 'max_sesion', 'min_sesion', 'ultima_actualizacion']
        hour_df['fecha'] = str(year+"/"+ month + "/" + day_iter )
