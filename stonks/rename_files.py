...
for day in ['04_21', '05_18', '05_19', '05_20', '05_21', '05_25', '05_26', '05_27', '05_28']:
    ...
    for hour in ["09_30", "10_30", "11_30", "12_30", "13_30", "14_30", "15_30", "16_30", "17_30", "18_30"]:
        try:
            #print("-----------------------------------------------------------------")
            #print(hour)
            hour_df = pd.read_csv("reduced_"+ year + "_" + day + "_" + hour + ".csv")
    ...
    day_df.to_csv("stonks/" + year+"_" + day + ".csv", index=False, header=False)
